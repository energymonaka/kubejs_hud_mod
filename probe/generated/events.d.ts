...
declare function onForgeEvent(name: "net.minecraftforge.client.event.ScreenEvent$PotionSizeEvent", handler: (event: Internal.ScreenEvent$PotionSizeEvent) => void);
...
declare function onForgeEvent(name: "net.minecraftforge.client.event.RenderGameOverlayEvent$BossInfo", handler: (event: Internal.RenderGameOverlayEvent$BossInfo) => void);
